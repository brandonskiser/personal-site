...
const IndexPage = () => {
  return (
    <div className="flex flex-col items-center w-full max-w-3xl m-auto p-4 pt-0">
      <SEO />
      <nav className="flex justify-end items-center gap-8 w-full h-20">
      ...
      <main className="flex flex-col gap-4">
        <h1 className="text-xl font-semibold">Brandon Kiser</h1>
        <div className="w-44 border border-primary"></div>
        <p>
          Hi! I'm a full stack software developer from Fresno, CA. You can email
          me at <a href="mailto:brandon@brandonk.dev">brandon@brandonk.dev</a>{" "}
          or reach out directly on LinkedIn.
        </p>

        <p>I'll do something with this site eventually. Maybe.</p>
      </main>
    </div>
  );
};
